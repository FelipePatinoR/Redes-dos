...
![Arquitectura](/Lab5/img-config-microtik/Paso%206.png "Arquitectura laboratorio 05")
...
![Arquitectura](/Lab5/img-config-microtik/Paso%208.png "Arquitectura laboratorio 05")
...
9. Agregar el direccionamiento para las dos redes externas WAN y la red interna LAN.
    ...
    ![Arquitectura](/Lab5/img-config-microtik/Paso%209.png "Arquitectura laboratorio 05")
    
10. Agregar un [Pool][5_2] en el segmento de la LAN que asigne direcciones entre 192.168.3.150-192.168.3.200.
![Arquitectura](/Lab5/img-config-microtik/Paso%2010.png "Arquitectura laboratorio 05")
11. Agregar un servidor [DHCP][5_3] y la información de puerta de enlace y DNS que enviara a los PC conectados a la LAN.
![Arquitectura](/Lab5/img-config-microtik/Paso%2011.png "Arquitectura laboratorio 05") 
12. Convertir a [estático][5_4] el arrendamiento DHCP para la MAC del PC de configuración.
![Arquitectura](/Lab5/img-config-microtik/Paso%2012.png "Arquitectura laboratorio 05")
13. Cambiar la ip estática del pc de configuración a 192.168.3.10.
14. Configurar la [WLAN][wlan] de nombre "REDES_42" para proveer conectividad inalámbrica.

15. Agregar una regla NAT en el cortafuegos para garantizar el enrutamiento en sistemas de IP publica como internet.
    ...
    ![Arquitectura](/Lab5/img-config-microtik/Paso%2014.png "Arquitectura laboratorio 05")
16. Agregar una regla NAT en el cortafuegos para mapear ([Port Forwarding][fwd]) un servicio web de la red LAN. 
...
17. Agregar la [ruta por defecto][5_7] 0.0.0.0/0.
